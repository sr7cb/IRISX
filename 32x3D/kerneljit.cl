JIT BEGIN
0 P10 252700 pointer_double
3 0 252700 2 
0 P11 252700 pointer_double
3 1 252700 2 
0 P1 320000 pointer_double
3 2 320000 2 
0 P3 252700 pointer_double
3 3 252700 2 
0 P7 226800 pointer_double
3 4 226800 2 
0 P8 252700 pointer_double
3 5 252700 2 
0 P5 226800 pointer_double
3 6 226800 2 
0 P9 252700 pointer_double
3 7 252700 2 
0 P2 274360 pointer_double
3 8 274360 2 
0 P6 226800 pointer_double
3 9 226800 2 
0 P4 274360 pointer_double
3 10 274360 2 
...
kernel void ker_code0(global double *X, double gamma1, global double *P1) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 64000))) {
...
kernel void ker_code1(global double *X, double gamma1, global double *P4) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 54872))) {
        double a796, a797, s132, s133, s134, s135, s136, s137, 
                s138, t156;
        int a795, b101;
        a795 = ((256*get_group_id(0)) + get_local_id(0));
        b101 = ((40*(a795 / 38)) + (((28*get_group_id(0)) + get_local_id(0)) % 38));
        s132 = X[(b101 + 1681)];
...
kernel void ker_code2(global double *P1, global double *P2, global double *P4) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 54872))) {
        ...
        b198 = ((40*(a1165 / 38)) + (((28*get_group_id(0)) + get_local_id(0)) % 38));
...
kernel void ker_code3(double gamma1, global double *P1, global double *P2) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 50540))) {
        ...
        a1486 = ((38*(a1485 / 38)) + (((28*get_group_id(0)) + get_local_id(0)) % 38));
...
kernel void ker_code5(double gamma1, global double *P1, global double *P5) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 45360))) {
        double s458, t266, t267, t268, t269;
        int a1900, b331, b332;
        a1900 = ((256*get_group_id(0)) + get_local_id(0));
        b331 = ((35*(a1900 / 35)) + (((11*get_group_id(0)) + get_local_id(0)) % 35));
...
kernel void ker_code6(global double *P1, global double *P3, global double *P5) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 45360))) {
        int a2178, b400;
        a2178 = ((256*get_group_id(0)) + get_local_id(0));
        b400 = ((35*(a2178 / 35)) + (((11*get_group_id(0)) + get_local_id(0)) % 35));
...
kernel void ker_code7(global double *P1, global double *P3) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 32768))) {
        int a2333, b417;
        a2333 = (get_local_id(0) + (256*get_group_id(0)));
        b417 = ((((35*(a2333 / 32)) + (get_local_id(0) % 32)) % 1120) + (1260*(a2333 / 1024)));
...
kernel void ker_code10(double gamma1, global double *P8, global double *P6) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 45360))) {
        ...
        b550 = ((38*(a2940 / 36)) + (((4*get_group_id(0)) + get_local_id(0)) % 36));
...
kernel void ker_code11(global double *P10, global double *P8, global double *P6) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 45360))) {
        ...
        b618 = ((38*(a3218 / 36)) + (((4*get_group_id(0)) + get_local_id(0)) % 36));
...
kernel void ker_code12(global double *P10, global double *P8) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 32768))) {
        ...
        b636 = ((((36*(a3374 / 32)) + (get_local_id(0) % 32)) % 1152) + (1260*(a3374 / 1024)));
...
kernel void ker_code15(double gamma1, global double *P7, global double *P9) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 45360))) {
        double s1116, t493, t494, t495, t496;
        int a3981, b769, b770;
        a3981 = ((256*get_group_id(0)) + get_local_id(0));
        b769 = ((38*(a3981 / 36)) + (((4*get_group_id(0)) + get_local_id(0)) % 36));
...
kernel void ker_code16(global double *P11, global double *P9, global double *P7) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 45360))) {
        ...
        b837 = ((38*(a4259 / 36)) + (((4*get_group_id(0)) + get_local_id(0)) % 36));
...
kernel void ker_code17(global double *P11, global double *P9) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 32768))) {
        ...
        b855 = ((((36*(a4415 / 32)) + (get_local_id(0) % 32)) % 1152) + (1296*(a4415 / 1024)));
