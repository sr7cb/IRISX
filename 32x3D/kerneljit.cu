...
extern "C" __global__ void ker_code17(double *P11, double *P9) {
    if (((((256*blockIdx.x) + threadIdx.x) < 32768))) {
        ...
        P11[(a4415 + (32*32*32))] = (P9[(b855 + 49320)] - P9[(b855 + 48024)]);
        P11[(a4415 + (32*32*32*2))] = (P9[(b855 + 94680)] - P9[(b855 + 93384)]);
        P11[(a4415 + (32*32*32*3))] = (P9[(b855 + 140040)] - P9[(b855 + 138744)]);
        P11[(a4415 + (32*32*32*4))] = (P9[(b855 + 185400)] - P9[(b855 + 184104)]);
    }
}
...
extern "C" __global__ void ker_code18(double *Y, double a_scale1, double dx1, double *P10, double *P11, double *P3) {
    if (((((256*blockIdx.x) + threadIdx.x) < 32768))) {
        ...
        a4485 = (a_scale1 / dx1);
        Y[a4484] = (a4485*(P3[a4484] + P10[(a4484 + 163840)] + P11[(a4484)]));
        a4486 = (a4484 + 32768);
        Y[a4486] = (a4485*(P3[a4486] + P10[(a4484 + 196608)] + P11[(a4486)]));
        a4487 = (a4484 + 65536);
        Y[a4487] = (a4485*(P3[a4487] + P10[(a4484 + 229376)] + P11[(a4487)]));
        a4488 = (a4484 + 98304);
        Y[a4488] = (a4485*(P3[a4488] + P10[(a4484 + 262144)] + P11[(a4488)]));
        a4489 = (a4484 + 131072);
        Y[a4489] = (a4485*(P3[a4489] + P10[(a4484 + 294912)] + P11[(a4489)]));
    }
}