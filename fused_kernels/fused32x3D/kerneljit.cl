...
3 1 680400 2 
2 ker_code0 215 1 1 256 1 1 X -1 P1 -2 gamma1 -1
2 ker_code1 198 1 1 256 1 1 P2 -2 P1 -1 gamma1 -1
2 ker_code2 178 1 1 256 1 1 P2 -1 P1 -2 gamma1 -1
2 ker_code3 129 1 1 256 1 1 P2 -2 P1 -1
2 ker_code4 129 1 1 256 1 1 Y -2 P2 -1 a_scale1 -1 dx1 -1
4 Y pointer_double
4 X pointer_double
4 gamma1 double
4 a_scale1 double
...
kernel void ker_code0(global double *X, global double *P1, double gamma1) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 54872))) {
        ...
        b132 = ((40*(a1244 / 38)) + ((get_local_id(0) + (28*get_group_id(0))) % 38));
        s292 = X[(b132 + 41)];
        s293 = X[(b132 + 1601)];
        s294 = X[(b132 + 1640)];
        s295 = X[(b132 + 1641)];
...
kernel void ker_code1(global double *P2, global double *P1, double gamma1) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 50540))) {
        ...
        a1981 = ((38*(a1943 / 38)) + (((28*get_group_id(0)) + get_local_id(0)) % 38));
...
kernel void ker_code2(global double *P2, global double *P1, double gamma1) {
    if (((((256*get_group_id(0)) + get_local_id(0)) < 45360))) {
        ...
        b615 = ((38*(a3214 / 36)) + (((4*get_group_id(0)) + get_local_id(0)) % 36));
        ...
        b618 = ((35*(a3214 / 35)) + (((11*get_group_id(0)) + get_local_id(0)) % 35));
        s1408 = P2[(b618 + 35)];
        s1409 = P2[(b618 + 1330)];
        s1410 = P2[(b618 + 1365)];
        s1411 = P2[(b618 + 1400)];
